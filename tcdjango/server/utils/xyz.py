...
def get_tile_data(driver: RasterDriver, dataset, tile_xyz: Tuple[int, int, int] = None,
    ...
    wgs_bounds = metadata.get_bounds()
    ...
    return driver.get_raster_tile(
        dataset=dataset, tile_bounds=target_bounds, tile_size=tile_size,
